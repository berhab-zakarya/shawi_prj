...
export default function Footer() {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        { name: "قانون الشركات", href: "/services/corporate" },
        { name: "القانون العقاري", href: "/services/real-estate" },
        { name: "القانون الجنائي", href: "/services/criminal" },
        { name: "قانون الأحوال الشخصية", href: "/services/personal" },
      ],
    },
  ]
  ...
  return (
    <>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="relative">
                    ...
                    />
                    <div className="absolute -inset-2 bg-gradient-to-r from-amber-500/20 to-orange-500/20 rounded-full blur-lg" />
                  </div>
                  <div>
              ...
              >
                <div className="space-y-6">
                  <h4 className="text-lg font-semibold text-white relative">
                    {section.title}
                    <div className="absolute -bottom-2 right-0 w-12 h-0.5 bg-gradient-to-r from-amber-500 to-orange-500 rounded-full" />
                  </h4>
                    ...
                    {section.links.map((link) => (
                      ...
                      >
                        <span className="relative">
                          {link.name}
                          <span className="absolute -bottom-0.5 right-0 w-0 h-0.5 bg-amber-500 transition-all duration-300 group-hover:w-full" />
                        </span>
                      </Link>
                    ))}
                  </nav>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="flex items-center gap-3 group">
                <div className="w-10 h-10 bg-slate-800 rounded-xl flex items-center justify-center text-amber-500 group-hover:bg-amber-500 group-hover:text-white transition-all duration-300">
                  <Mail className="w-5 h-5" />
                </div>
                <div>
                  <p className="text-slate-400 text-sm">البريد الإلكتروني</p>
                  <a href="mailto:info@elshawi-law.ae" className="text-slate-200 hover:text-white transition-colors duration-200">
                    info@elshawi-law.ae
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 group">
                ...
                <div>
                  ...
                  <a href="tel:+971501234567" className="text-slate-200 hover:text-white transition-colors duration-200">
                    +971 50 123 4567
                  </a>
                </div>
              </div>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 left-8 w-12 h-12 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-50 flex items-center justify-center"
